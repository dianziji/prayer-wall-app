...
const HeartIcon = ({ filled }: { filled: boolean }) => (
  filled ? (
    ...
    <svg className="w-5 h-5 stroke-gray-400" viewBox="0 0 24 24"
         fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12.1 21.23l-.1.1-.11-.1C7.14 17.07 4 14.16 4 10.5 4 7.42
               6.42 5 9.5 5c1.74 0 3.41.81 4.5 2.09C15.09 5.81
               16.76 5 18.5 5 21.58 5 24 7.42 24 10.5c0 3.66-3.14
               6.57-7.79 10.73z" />
    </svg>
  )
);
